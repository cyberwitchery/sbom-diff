...
- fix `--fail-on version-downgrade` for Maven versions: a qualifier like `1.0-SNAPSHOT` could not be compared against its release at all, and `1.0-Final` -> `1.0-SNAPSHOT` was ranked as an upgrade
