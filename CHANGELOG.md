...
- convert `Sbom::detect_cycles()` from recursive to iterative stack-based DFS to prevent stack overflow on deep dependency graphs; behaviour and public API are unchanged
